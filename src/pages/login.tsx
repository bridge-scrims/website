  ...
  return (
    <>
      <LandingImageSection id={styles.Wrapper}>
          ...
          <div id={styles.LogoWrapper}><Image className={styles.logo} src={logo} alt="Logo" height="65" /></div>
          <h1>{"Log In"}</h1>
					<div className="mb-3">
						<label htmlFor="code" className="form-label form-check-label">Linking Code</label>
            ...
            <div className="invalid-feedback">Couldn&apos;t be verified!</div>
					...
					<div className="mb-3">
						<button type="submit" className="btn form-control" id={Inputs.Submit}>Log in</button>
					</div>
				</form>
			</LandingImageSection>
    </>
